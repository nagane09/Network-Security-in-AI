...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric, run_name="run"):
        ...
        try:
            ...
            logging.error(f"Failed to track MLflow run: {e}")
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        ...
        params = {
            ...
            "Gradient Boosting": {'learning_rate': [0.1, 0.01, 0.05, 0.001], 'subsample': [0.6, 0.7, 0.75, 0.85, 0.9], 'n_estimators': [8, 16, 32, 64, 128, 256]},
            "Logistic Regression": {},
        ...
        # Track MLflow locally for training
        ...
        # Track MLflow locally for testing
